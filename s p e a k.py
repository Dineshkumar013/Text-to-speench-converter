...
root.title("Google's Speech Application done by dinesh")
...
but1=Button(root,text='Convert',width=20,bg='yellow',fg='blue',command=fetch).place(x=125,y=100)

but2=Button(root,text='Play file',width=20,bg='yellow',fg='blue',command=play).place(x=125,y=140)
